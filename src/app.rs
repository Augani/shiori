...
impl AppState {
    ...
    fn enumerate_mono_fonts(cx: &App) -> Vec<String> {
        let all_names = cx.text_system().all_font_names();
        let mut mono: Vec<String> = all_names
            .into_iter()
            .filter(|name| {
